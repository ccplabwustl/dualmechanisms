function output = rt_SSBoll79(signal,fs,IS)
...
clear x signal wnd y
for i = 1:numberOfFrames
    [~, SpeechFlag, NoiseCounter, Dist]=vad(Y(:,i).^(1/Gamma),N.^(1/Gamma),NoiseCounter); %Magnitude Spectrum Distance VAD
    if SpeechFlag == 0
